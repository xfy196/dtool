...
const { favoriteTools, tools, latestTools } = storeToRefs(useToolStore());
</script>
...
<template>
      <div class="mt-2">
        ...
        <ToolCards :tools="latestTools" class="mt-2" />
      </div>
      <!-- 我的收藏 -->
      <div class="mt-2">
        <div v-show="favoriteTools.length" class="text-xl font-bold">
          我的收藏
        </div>
        <ToolCards class="mt-2" :tools="favoriteTools" />
      </div>
      <!-- 全部工具 -->
      <div class="mt-2">
